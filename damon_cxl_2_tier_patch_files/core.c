...
EXPORT_SYMBOL(damon_new_region);
...
EXPORT_SYMBOL(damon_add_region);
...
EXPORT_SYMBOL(damon_destroy_region);
/*
...
EXPORT_SYMBOL(damon_set_regions);
...
EXPORT_SYMBOL(damos_destroy_filter);
...
EXPORT_SYMBOL(damos_destroy_quota_goal);
...
EXPORT_SYMBOL(damon_add_scheme);
...
EXPORT_SYMBOL(damon_targets_empty);
...
EXPORT_SYMBOL(damon_free_target);
...
EXPORT_SYMBOL(damon_nr_regions);
...
EXPORT_SYMBOL(damos_commit_quota_goals);
...
EXPORT_SYMBOL(damon_nr_running_ctxs);
...
EXPORT_SYMBOL(damon_update_region_access_rate);
